...
h = 0.25:0.1:0.65; % bandwidth grid

% Define random seeds
s_pm = 54639;  % seed for generating true theta parameter (should be same across all sims/batches sharing same p)
s_dt = 419687;  % seed for generating random data (different values for different sims/batches)
...
optns = struct('Ret', 1, 'maxIter', 70, 'thetaInit', thetaInit, 'thetaChoose', 5, 'Algorithm', optType); % max of 70 iterations per starting value
