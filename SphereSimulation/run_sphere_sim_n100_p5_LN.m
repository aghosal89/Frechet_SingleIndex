...
h = 0.15:0.1:0.65; % grid of bandwidths

% Define random seeds
s_pm = 49156;  % seed for generating true theta parameter (should be same across all sims/batches sharing same p)
s_dt = 677496;  % seed for generating random data (different values for different sims/batches)
...
fnm = strcat('Sphere_results_n', num2str(n), '_nsim', num2str(nsim), '_p', num2str(p), '_noise', noise, '.mat');
