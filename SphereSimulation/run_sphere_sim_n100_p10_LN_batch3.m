...
numWk = 31; % if usePar = 1, how many workers should be used.
...
s_dt = 133067;  % seed for generating random data (different values for different sims/batches)
