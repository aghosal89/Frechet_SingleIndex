...
numWk = 61; % if usePar = 1, how many workers should be used.
...
s_dt = 132489;  % seed for generating random data (different values for different sims/batches)
