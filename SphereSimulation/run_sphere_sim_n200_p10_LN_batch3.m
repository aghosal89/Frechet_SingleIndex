...
numWk = 39; % if usePar = 1, how many workers should be used.
...
s_dt = 13648;  % seed for generating random data (different values for different sims/batches)
