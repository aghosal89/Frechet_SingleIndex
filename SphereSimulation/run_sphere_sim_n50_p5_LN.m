...
numWk = 40; % if usePar = 1, how many workers should be used.
...
h = 0.15:0.1:0.55; % grid of bandwidths

% Define random seeds
s_pm = 49156;  % seed for generating true theta parameter (should be same across all sims/batches sharing same p)
s_dt = 946381;  % seed for generating random data (different values for different sims/batches)
...
optns = struct('Ret', 1, 'maxIter', 50, 'thetaInit', thetaInit, 'thetaChoose', 4, 'Algorithm', optType); % max of 50 iterations per starting value
