...
% p = 2; pInd = 1; % uncomment this to look at data sets for covariate
% dimension 2 only
p = 5; pInd = 2; % uncomment this to look at data sets for covariate
% dimension 5 only
% p = 10; pInd = 3; uncomment this to look at data sets for covariate
% dimension 10 only 
