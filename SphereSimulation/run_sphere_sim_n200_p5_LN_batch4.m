...
s_dt = 573664;  % seed for generating random data (different values for different sims/batches)
...
fnm = strcat('Sphere_results_n', num2str(n), '_nsim', num2str(nsim), '_p', num2str(p), '_noise', noise, 'batch4.mat');
